# SPEC.md — Identité de Nova

## Objectif

L'assistant a une identité reconnaissable dès l'ouverture de la page : un nom, un emoji, un message d'accueil et trois questions pour démarrer, sur le thème du cinéma de science-fiction.
...
- **Suggestions** :
  1. `Quels sont les meilleurs films de science-fiction de tous les temps ?`
  2. `Explique-moi l'univers de Star Wars`
  3. `Quelle est la différence entre space opera et cyberpunk ?`
...
4. **Suggestions** — Quand la page s'ouvre, le système propose exactement trois questions suggérées, liées au cinéma de science-fiction. Quand l'utilisateur clique sur l'une d'elles, le système la place dans le champ de saisie sans l'envoyer.
5. **Réponses signées** — Quand l'assistant répond, sa ligne commence par son nom (« Nova ») au lieu de « Cap Web ».
