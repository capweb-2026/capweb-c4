...
Nova est un chatbot en JavaScript natif, sans framework, spécialisé dans le cinéma de science-fiction. Il répond avec un cerveau à règles et, à partir de mercredi, avec une IA appelée par le serveur.
...
- `public/js/persona.js` : identité de l'assistant (`persona` et `validatePersona`) ;
...
- Ne jamais sortir du thème du cinéma de science-fiction dans les réponses de l'assistant.
